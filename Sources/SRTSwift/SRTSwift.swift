...
public class SRTSocket {
  ...
  public init(options: SRTOptions.PreBindOptions) throws {
    self.socketID = srt_create_socket()
    try setPreBindOptions(options)

  }

  public func setOptions(_ options: SRTOptions.PostOptions) throws {
    try setPostOptions(options)
  }

}

extension SRTSocket {
  private func setPreBindOptions(_ options: SRTOptions.PreBindOptions) throws {
  ...
  private func setPreOptions(_ options: SRTOptions.PreOptions) throws {
  ...
  private func setPostOptions(_ options: SRTOptions.PostOptions) throws {
